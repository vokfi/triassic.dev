                ...
                <div className="bg-slate-900 w-full h-full">
                    <div className="flex flex-col items-center justify-center h-screen">
                        <div className="bg-slate-700 p-8 rounded-lg">
                            ...
                            <p className="italic text-slate-500 text-md mb-6">and a Minecraft Server Developer just for fun.</p>
                        </div>
                        ...
                        <div className="container text-center mt-16">
                            <a data-tip="Go to the next page" className="text-4xl text-slate-200" href="#section-2">
                                <FontAwesomeIcon icon={faAngleDown}></FontAwesomeIcon>
                            </a>
                        </div>
                        <p className="text-center text-lg text-slate-400 italic">Keep going to find out more about me ;)</p>
                    </div>
                </div>
            </section>
        </>
